...
def normalize(probabilities):
    ...
    for person in probabilities:
        for t in ['gene', 'trait']:
            summed = sum(probabilities[person][t].values())
            for category in probabilities[person][t]:
                val = probabilities[person][t][category]
                normalized_val = val / summed
                normalized[person][t][category] = normalized_val
    return normalized
